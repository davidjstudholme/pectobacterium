...
#Place your command lines below this
	...
	rm PRT5_1_val.versus.BY2_brasiliense.fasta.aln.sam

	rm PRT5_1_val.versus.BY2_brasiliense.fasta.aln.bam

	rm PRT5_1_val.versus.BY2_brasiliense.fasta.aln.bam.sorted.bam
