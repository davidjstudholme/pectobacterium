...
#Place your command lines below this
	...
	rm 41_1_val.versus.ZRIMU1702DQ_brasiliense.fasta.aln.sam

	rm 41_1_val.versus.ZRIMU1702DQ_brasiliense.fasta.aln.bam

	rm 41_1_val.versus.ZRIMU1702DQ_brasiliense.fasta.aln.bam.sorted.bam
