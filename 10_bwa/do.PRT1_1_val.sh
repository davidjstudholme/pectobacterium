...
#Place your command lines below this
	...
	rm PRT1_1_val.versus.BY2_brasiliense.fasta.aln.sam

	rm PRT1_1_val.versus.BY2_brasiliense.fasta.aln.bam

	rm PRT1_1_val.versus.BY2_brasiliense.fasta.aln.bam.sorted.bam
